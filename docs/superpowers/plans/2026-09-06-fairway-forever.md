# Fairway Forever Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-05-fairway-forever-design.md`

## Global Constraints

- Bundle id `com.thomashall.FairwayFit`, display name **Fairway Forever**, target and scheme name `FairwayFit`.
  ...
  FairwayFit:
    ...
    settings:
      base:
        ...
        INFOPLIST_KEY_CFBundleDisplayName: "Fairway Forever"
