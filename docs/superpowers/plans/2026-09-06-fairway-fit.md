# Fairway Fit Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-05-fairway-fit-design.md`

## Global Constraints

- Bundle id `com.thomashall.FairwayFit`, display name **Fairway Fit**, target and scheme name `FairwayFit`.
  ...
  FairwayFit:
    ...
    settings:
      base:
        ...
        INFOPLIST_KEY_CFBundleDisplayName: "Fairway Fit"
